...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/xiaomi/camera/mivi/ImageReceiverExecutor;->mHandler:Landroid/os/Handler;

    const/16 v2, 0xf

    invoke-virtual {v0, p1, v1, v2}, Lcom/xiaomi/camera/mivi/ImageReceiverFactory;->init(Landroid/content/Context;Landroid/os/Handler;I)V
...
.method private loop()V
    ...
    const-string v2, "loop: requestData is null"
    ...
    const-string v0, "loop: break with null receiver"
...
.method public synthetic OooO00o()V
    ...
    .line 3
    iget-object v0, p0, Lcom/xiaomi/camera/mivi/ImageReceiverExecutor;->mReprocessThread:Ljava/lang/Thread;
    ...
    invoke-virtual {v0}, Lcom/xiaomi/camera/mivi/ImageReceiverFactory;->release()V
...
.method public synthetic OooO0OO()V
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcom/xiaomi/camera/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;J)Lcom/xiaomi/camera/core/ParallelTaskData;
    ...
    const-string v5, "reprocess with CvReProcessor"

    .line 13
    invoke-static {v4, v1, v5}, Lcom/android/camera/log/Log;->k(ILjava/lang/String;Ljava/lang/String;)I
    ...
    const-string v5, "reprocess with VtReProcessorProxy"
