...
.method private initAttributePointer()V
    ...
    .line 12
    iget v0, p0, Lcom/xiaomi/renderengine/program/TextureProgram;->mAttributeTexCoorH:I
...
.method private initShader()V
    ...
    const-string v1, "Texture type Unsupported"
    ...
    .line 4
    invoke-static {v1, v0}, Lcom/xiaomi/renderengine/gl/GLUtils;->createProgram(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-class v2, Lcom/xiaomi/renderengine/program/TextureProgram;
...
.method private initShaderValue(I[FLcom/xiaomi/renderengine/GLState;)V
    .locals 4

    .line 1
    invoke-virtual {p3}, Lcom/xiaomi/renderengine/GLState;->getAlpha()F

    move-result v0

    .line 2
    invoke-virtual {p3}, Lcom/xiaomi/renderengine/GLState;->getBlendAlpha()F
    ...
    :cond_0
    invoke-virtual {p3}, Lcom/xiaomi/renderengine/GLState;->getTexMatrix()[F
    ...
    invoke-virtual {p3}, Lcom/xiaomi/renderengine/GLState;->getFinalMatrix()[F
    ...
    .line 13
    iget p1, p0, Lcom/xiaomi/renderengine/program/TextureProgram;->mUniformBlendAlphaH:I
...
# virtual methods
.method public draw(IIII[FLandroid/graphics/Rect;Lcom/xiaomi/renderengine/GLState;)I
    .locals 2

    .line 1
    invoke-virtual {p7}, Lcom/xiaomi/renderengine/GLState;->pushState()V
    ...
    .line 4
    invoke-virtual {p7}, Lcom/xiaomi/renderengine/GLState;->identityAllM()V
    ...
    .line 9
    invoke-virtual {p7, v1, p3, v1, p4}, Lcom/xiaomi/renderengine/GLState;->ortho(FFFF)V
    ...
    invoke-virtual {p7, p3, p4, v1}, Lcom/xiaomi/renderengine/GLState;->translate(FFF)V
    ...
    invoke-virtual {p7, p3, p4, p6}, Lcom/xiaomi/renderengine/GLState;->scale(FFF)V

    .line 12
    invoke-direct {p0, p1, p5, p7}, Lcom/xiaomi/renderengine/program/TextureProgram;->initShaderValue(I[FLcom/xiaomi/renderengine/GLState;)V
    ...
    .line 16
    iget p1, p0, Lcom/xiaomi/renderengine/program/TextureProgram;->mAttributeTexCoorH:I

    invoke-static {p1}, Landroid/opengl/GLES20;->glDisableVertexAttribArray(I)V

    .line 17
    invoke-virtual {p7}, Lcom/xiaomi/renderengine/GLState;->popState()V
    ...
    iget p3, p0, Lcom/xiaomi/renderengine/program/TextureProgram;->mProgram:I
