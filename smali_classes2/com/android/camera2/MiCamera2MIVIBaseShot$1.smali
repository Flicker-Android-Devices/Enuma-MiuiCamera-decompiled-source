...
.method public onCaptureCompleted()V
    ...
    const-string v0, "onAllHalFrameReceived: 2 onCaptureStarted is not called, so wait for it"
    ...
    invoke-virtual {v0}, Lcom/android/camera2/MiCamera2MIVIBaseShot;->handleCaptureFinished()V
...
.method public onCaptureFailed()V
    ...
    invoke-virtual {v2, v1, v0}, Lcom/android/camera2/MiCamera2;->onCapturePictureFinished(ZLcom/android/camera2/MiCamera2Shot;)V
...
.method public onImageReceived(Lcom/xiaomi/camera/mivi/bean/ResultOutputData;)V
    ...
    invoke-direct {v0, p0, p1}, LOooO0O0/OooO0O0/OooO0O0/OooO0oo;-><init>(Lcom/android/camera2/MiCamera2MIVIBaseShot$1;Lcom/xiaomi/camera/mivi/bean/ResultOutputData;)V
    ...
    .line 5
    invoke-virtual {v1, v0, p1, v2}, Lcom/android/camera/module/loader/camera2/ButtonStatus;->checkStatus(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
