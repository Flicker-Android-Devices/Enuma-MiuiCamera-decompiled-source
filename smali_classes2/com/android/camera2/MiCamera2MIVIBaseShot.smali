...
# static fields
.field public static final CALLBACK_STATE_FINISH:I = 0x2
...
.method private generateEarlyPictureData()V
    ...
    invoke-virtual {v0, v4}, Lcom/xiaomi/camera/core/ParallelTaskData;->setNoGaussian(Z)V
...
.method public handleEarlyImageIfNeed()V
    ...
    const-string v0, "handleEarlyImageIfNeed: with null image"
    ...
    const-string v0, "handleEarlyImageIfNeed: with null mCurrentParallelTaskData"
    ...
    const-string v2, "handleEarlyImageIfNeed: has already handle early image, timestamp > "
    ...
    const-string v3, "onImageReceived[EARLY] : something wrong happened when image received: "
    ...
    .line 13
    :cond_4
    iput-boolean v2, p0, Lcom/android/camera2/MiCamera2MIVIBaseShot;->mHandledEarlyImage:Z
    ...
    const-string v0, "onImageReceived[EARLY] : image arrived first"
    ...
    invoke-virtual {v0, v2, v3}, Lcom/xiaomi/camera/core/ParallelTaskData;->setTimestamp(J)V
    ...
    const-string v2, "handleEarlyImageIfNeed: 1 "
    ...
    .line 19
    iget-object v2, p0, Lcom/android/camera2/MiCamera2ShotParallel;->mButtonStatus:Lcom/android/camera/module/loader/camera2/ButtonStatus;
    ...
    const-string v3, "handleEarlyImageIfNeed: runnable "
    ...
    .line 23
    invoke-virtual {v1, v0, v2, v3}, Lcom/android/camera/module/loader/camera2/ButtonStatus;->checkStatus(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
    ...
    const-string v2, "onImageReceived[EARLY] : discard early picture in case of no need thumbnail, mEarlyImage\'s timestamp = "
...
.method public notifyResultData(Lcom/xiaomi/camera/core/ParallelTaskData;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    const-string p1, "notifyResultData: return for intent capture"
    ...
    .line 10
    iget-object p3, p0, Lcom/android/camera2/MiCamera2MIVIBaseShot;->mCurrentParallelTaskData:Lcom/xiaomi/camera/core/ParallelTaskData;
    ...
    invoke-interface {p1, p2, p3, p4, v0}, Lcom/android/camera2/Camera2Proxy$PictureCallback;->onPictureTakenFinished(ZJI)V
...
.method public updatePictureInfoIfNeed(Lcom/xiaomi/camera/mivi/bean/ResultOutputData;Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    const-string v3, "updatePictureInfoIfNeed: hdrEnable > "
    ...
    const-string v2, "onFinalImageReceived: algorithmInfo > "
    ...
    .line 11
    invoke-virtual {p2, p1}, Lcom/xiaomi/camera/core/PictureInfo;->setExtraInfo(Ljava/lang/String;)V
