.class public interface abstract Lcom/android/camera2/compat/theme/MiThemeOperationTabIf;
...
.method public getDragConfig(Landroid/content/Context;)Lcom/android/camera/ui/DragLayout$DragAnimationConfig;
    ...
    .line 1
    new-instance v0, Lcom/android/camera/ui/DragLayout$DragAnimationConfig;

    invoke-direct {v0, p1}, Lcom/android/camera/ui/DragLayout$DragAnimationConfig;-><init>(Landroid/content/Context;)V
...
.method public getMenuItemCreator(Landroid/content/Context;)Lcom/android/camera/fragment/modeselector/menu/FragmentBottomMenuBase$ItemCreator;
    ...
    .line 1
    new-instance v0, LOooO0O0/OooO0O0/OooO0O0/OooOOO/OooO00o/OooO00o;

    invoke-direct {v0, p1}, LOooO0O0/OooO0O0/OooO0O0/OooOOO/OooO00o/OooO00o;-><init>(Landroid/content/Context;)V
...
.method public getMoreItemBottomMargin(Landroid/content/Context;)I
    ...
    .line 1
    invoke-interface {p0, p1}, Lcom/android/camera2/compat/theme/MiThemeOperationTabIf;->getModeItemHeight(Landroid/content/Context;)I

    move-result v0

    invoke-interface {p0, p1}, Lcom/android/camera2/compat/theme/MiThemeOperationTabIf;->getModeItemWidth(Landroid/content/Context;)I
...
.method public popupMoreMode(FFFLcom/android/camera/animation/FolmeUtils$IPhyAnimatorListener;)V
    ...
    new-instance v0, Lcom/android/camera2/compat/theme/MiThemeOperationTabIf$1;

    invoke-direct {v0, p0, p4, p4}, Lcom/android/camera2/compat/theme/MiThemeOperationTabIf$1;-><init>(Lcom/android/camera2/compat/theme/MiThemeOperationTabIf;Lcom/android/camera/animation/FolmeUtils$IPhyAnimatorListener;Lcom/android/camera/animation/FolmeUtils$IPhyAnimatorListener;)V
