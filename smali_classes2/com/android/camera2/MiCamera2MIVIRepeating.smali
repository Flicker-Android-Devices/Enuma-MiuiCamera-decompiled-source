...
.method public constructor <init>(Lcom/android/camera2/MiCamera2;ILandroid/view/Surface;)V
    ...
    .line 2
    iput-boolean p1, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->isFirstRequest:Z
    ...
    .line 4
    iput p2, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mMaxCapturedNum:I
...
.method public static synthetic access$200(Lcom/android/camera2/MiCamera2MIVIRepeating;)I
    .locals 0

    .line 1
    iget p0, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mLatestSequenceId:I

    return p0
.end method

.method public static synthetic access$202(Lcom/android/camera2/MiCamera2MIVIRepeating;I)I
    .locals 0

    .line 1
    iput p1, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mLatestSequenceId:I

    return p1
.end method

.method public static synthetic access$300(Lcom/android/camera2/MiCamera2MIVIRepeating;)I
    .locals 0

    .line 1
    iget p0, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mCurrentSequenceId:I

    return p0
.end method

.method public static synthetic access$400(Lcom/android/camera2/MiCamera2MIVIRepeating;ZI)V
    .locals 0
...
.method private onImageReceived(Lcom/xiaomi/camera/mivi/bean/ResultOutputData;Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    .line 2
    iget v0, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mCaptureRequestNum:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mCaptureRequestNum:I
    ...
    invoke-interface {v0, p2, v5, v6, v6}, Lcom/xiaomi/camera/core/ParallelCallback;->onParallelProcessFinish(Lcom/xiaomi/camera/core/ParallelTaskData;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    invoke-static {v2, v1, p2}, Lcom/android/camera/log/Log;->k(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p2, p1}, Lcom/xiaomi/camera/MIVICaptureManager;->releaseData(Lcom/xiaomi/camera/mivi/bean/ResultOutputData;)V
...
.method private onRepeatingEnd(ZI)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera2/MiCamera2;->setAWBLock(Z)V
...
.method public generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v2}, Lcom/android/camera2/MiCamera2;->getOutputPictureFormat()I
    ...
    instance-of v3, v1, Lcom/android/camera/module/image/MultiCaptureManager$JpegRepeatingCaptureCallback;
...
.method public startSessionCapture()V
    ...
    iget v1, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mMaxCapturedNum:I
    ...
    iget-boolean v1, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->isFirstRequest:Z
    ...
    .line 10
    iget-object v5, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mZoomMapSurface:Landroid/view/Surface;
    ...
    invoke-virtual {v5}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->oo00oO()Z
    ...
    .line 13
    iget-boolean v5, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->isFirstRequest:Z
    ...
    .line 14
    :goto_0
    iput-boolean v0, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->isFirstRequest:Z
    ...
    .line 16
    iget v8, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mCaptureRequestNum:I

    add-int/2addr v8, v6

    iput v8, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mCaptureRequestNum:I

    .line 17
    iput v7, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mCurrentSequenceId:I

    .line 18
    iget v9, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mMaxCapturedNum:I

    if-ne v8, v9, :cond_4

    .line 19
    iput v7, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mLatestSequenceId:I
    ...
    iget v9, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mLatestSequenceId:I
    ...
    iget v7, p0, Lcom/android/camera2/MiCamera2MIVIRepeating;->mCaptureRequestNum:I
    ...
    invoke-static {v0, v5}, Lcom/android/camera/log/Log;->dumpRequest(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;)V
