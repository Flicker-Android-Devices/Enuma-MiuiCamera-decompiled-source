...
.method public constructor <init>(Lcom/android/camera2/MiCamera2;Lcom/android/camera/module/loader/camera2/ButtonStatus;)V
    ...
    .line 2
    iput p1, p0, Lcom/android/camera2/MiCamera2MIVIStill;->mSequenceID:I
...
.method public static synthetic access$100(Lcom/android/camera2/MiCamera2MIVIStill;)I
    .locals 0

    .line 1
    iget p0, p0, Lcom/android/camera2/MiCamera2MIVIStill;->mSequenceID:I

    return p0
.end method

.method public static synthetic access$200(Lcom/android/camera2/MiCamera2MIVIStill;)V
    .locals 0
...
.method private handleRawImageDataIfNeed()V
    ...
    const-string v1, "handleRawImageDataIfNeed: no image!"
    ...
    const-string v1, "handleRawImageData: return because handled already!"
    ...
    invoke-static {v3}, Lcom/android/camera2/CameraCapabilitiesUtil;->getCameraCharacteristics(Lcom/android/camera2/CameraCapabilities;)Landroid/hardware/camera2/CameraCharacteristics;

    move-result-object v3

    const-string v4, "RAW"

    invoke-interface {v0, v1, v2, v3, v4}, Lcom/xiaomi/camera/core/ParallelCallback;->onParallelProcessFinish(Lcom/xiaomi/camera/core/ParallelTaskData;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    const-string v1, "handleRawImageDataIfNeed: return because of data is not ready!"
...
.method public handleCaptureFinished()V
    ...
    const-string v3, "onCaptureCompleted: something wrong: callback = "
    ...
    invoke-virtual {v1}, Lcom/android/camera2/MiCamera2;->onParallelImagePostProcStart()V
    ...
    invoke-virtual {v1, v2, p0}, Lcom/android/camera2/MiCamera2;->onCapturePictureFinished(ZLcom/android/camera2/MiCamera2Shot;)V
    ...
    const-string v3, "handleCaptureFinished: notify pictureTakenFinished"
    ...
    invoke-interface {v0, v2, v3, v4, v1}, Lcom/android/camera2/Camera2Proxy$PictureCallback;->onPictureTakenFinished(ZJI)V
...
.method public onFinalImageReceived(Lcom/xiaomi/camera/mivi/bean/ResultOutputData;)V
    ...
    const-string v2, "onImageReceive: update shotType to INTENT_PARALLEL_SINGLE_SHOT"
    ...
    invoke-virtual {v0, p1}, Lcom/xiaomi/camera/MIVICaptureManager;->releaseData(Lcom/xiaomi/camera/mivi/bean/ResultOutputData;)V
    ...
    const-string v3, "onImageReceived MIVI: something wrong happened when image received: "
...
.method public prepare()V
    ...
    .line 5
    iput-boolean v1, p0, Lcom/android/camera2/MiCamera2MIVIStill;->mNeedCaptureResult:Z
...
.method public startSessionCapture()V
    ...
    iput v1, p0, Lcom/android/camera2/MiCamera2MIVIStill;->mSequenceID:I
    ...
    iget v2, p0, Lcom/android/camera2/MiCamera2MIVIStill;->mSequenceID:I

    iget-object v3, p0, Lcom/android/camera2/MiCamera2MIVIBaseShot;->mFinalPictureListener:Lcom/xiaomi/camera/MIVICaptureManager$FinalPictureListener;

    invoke-virtual {v1, v2, v3}, Lcom/xiaomi/camera/MIVICaptureManager;->addListener(ILcom/xiaomi/camera/MIVICaptureManager$FinalPictureListener;)V
    :try_end_0
