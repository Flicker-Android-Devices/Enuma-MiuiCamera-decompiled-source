...
.method public readEntity(Landroid/database/Cursor;Lcom/android/camera/db/element/SaveTask;I)V
    ...
    :goto_4
    invoke-virtual {p2, v0}, Lcom/android/camera/db/element/SaveTask;->setThumbnailPath(Ljava/lang/String;)V
    ...
    :goto_5
    invoke-virtual {p2, v0, v1}, Lcom/android/camera/db/element/SaveTask;->setSize(J)V
    ...
    :goto_6
    invoke-virtual {p2, v0}, Lcom/android/camera/db/element/SaveTask;->setMimeType(Ljava/lang/String;)V
    ...
    :goto_7
    invoke-virtual {p2, v3, v4}, Lcom/android/camera/db/element/SaveTask;->setDateTaken(J)V
    ...
    :goto_8
    invoke-virtual {p2, v0}, Lcom/android/camera/db/element/SaveTask;->setWidth(I)V
    ...
    :goto_9
    invoke-virtual {p2, v0}, Lcom/android/camera/db/element/SaveTask;->setHeight(I)V
    ...
    :goto_a
    invoke-virtual {p2, v2}, Lcom/android/camera/db/element/SaveTask;->setBucketId(Ljava/lang/String;)V
    ...
    :goto_b
    invoke-virtual {p2, v3}, Lcom/android/camera/db/element/SaveTask;->setProgressAnimType(I)V
