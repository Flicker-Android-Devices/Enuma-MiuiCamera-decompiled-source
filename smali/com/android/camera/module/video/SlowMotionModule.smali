...
.field public mIsNeededPassThisRecording:Ljava/lang/Boolean;
...
.method public static constructor <clinit>()V
    ...
    invoke-virtual {v0}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o0O00o00()I
    ...
    invoke-virtual {v0}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o0O00Ooo()I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/module/video/SlowMotionModule;->mIsNeededPassThisRecording:Ljava/lang/Boolean;
...
.method private postProcessVideo(Lcom/android/camera/storage/mediastore/VideoFile;)Ljava/lang/String;
    ...
    .line 4
    :cond_0
    iget-object v0, v1, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lcom/android/camera/module/video/UserRecordSetting;
    ...
    invoke-virtual {v7, v13}, Lcom/android/camera/protocol/ModeCoordinatorImpl;->getAttachProtocol(I)Lcom/android/camera/protocol/ModeProtocol$BaseProtocol;

    move-result-object v7

    check-cast v7, Lcom/android/camera/protocol/ModeProtocol$SlowMotionViewProtocol;
    ...
    .line 16
    invoke-static {v8, v13, v9}, Lcom/android/camera/log/Log;->k(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v3, v9}, Lcom/android/camera/module/impl/component/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-virtual {v9}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o0000OO()I
    ...
    .line 21
    iget-object v9, v1, Lcom/android/camera/module/video/SlowMotionModule;->mIsNeededPassThisRecording:Ljava/lang/Boolean;
    ...
    iput-object v0, v1, Lcom/android/camera/module/video/SlowMotionModule;->mIsNeededPassThisRecording:Ljava/lang/Boolean;
    ...
    const-string/jumbo v10, "postProcessVideo: end "

    const/4 v11, 0x3

    invoke-static {v11, v8, v10}, Lcom/android/camera/log/Log;->k(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v0, v8}, Lcom/android/camera/storage/mediastore/ScopedStorageUtil;->transfer(Ljava/lang/String;Ljava/io/FileDescriptor;)Z
    ...
    .line 35
    iget v0, v1, Lcom/android/camera/module/BaseModule;->mModuleIndex:I

    invoke-interface {v7, v0}, Lcom/android/camera/protocol/ModeProtocol$SlowMotionViewProtocol;->setMotionDetectionViewAlpha(I)V
    :try_end_9
...
.method public doLaterReleaseIfNeed()V
    ...
    invoke-interface {v0, v1}, Lcom/android/camera/protocol/ModeProtocol$SlowMotionViewProtocol;->cancelRectAnimator(I)V
...
.method public doVideoPostProcess(J)Z
    ...
    sget-object p2, Lcom/android/camera/performance/Action$Event;->SLOW_MOTION_SAVING:Lcom/android/camera/performance/Action$Event;
    ...
    sget-object v5, Lcom/android/camera/performance/Action$Event;->SLOW_MOTION_SAVING:Lcom/android/camera/performance/Action$Event;
...
.method public getSeekToDuration()J
    ...
    iget-wide v1, v0, Lcom/android/camera/module/video/UserRecordSetting;->mMotionDetectionFrameTimens:J

    iget-wide v3, v0, Lcom/android/camera/module/video/UserRecordSetting;->mStartRecordTimens:J
...
.method public onPreviewMetaDataUpdate(Landroid/hardware/camera2/CaptureResult;)V
    ...
    iget-wide v3, v3, Lcom/android/camera/module/video/UserRecordSetting;->mMotionDetectionFrameTimens:J
    ...
    invoke-static {v3, p1}, Lcom/android/camera2/CaptureResultParser;->getMotionDetectionStatus(Lcom/android/camera2/CameraCapabilities;Landroid/hardware/camera2/CaptureResult;)J
    ...
    iput-wide v7, v3, Lcom/android/camera/module/video/UserRecordSetting;->mMotionDetectionFrameTimens:J

    .line 8
    iget-object v3, p0, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lcom/android/camera/module/video/UserRecordSetting;

    iget-wide v7, v3, Lcom/android/camera/module/video/UserRecordSetting;->mMotionDetectionFrameTimens:J

    iget-wide v3, v3, Lcom/android/camera/module/video/UserRecordSetting;->mStartRecordTimens:J
    ...
    iput-wide v5, p1, Lcom/android/camera/module/video/UserRecordSetting;->mMotionDetectionFrameTimens:J
    ...
    .line 11
    invoke-static {v3}, Lcom/android/camera/CameraSettings;->setMotionDetectionAnimator(Z)V
    ...
    invoke-interface {v0, v4, v5, v3}, Lcom/android/camera/protocol/ModeProtocol$SlowMotionViewProtocol;->setMotionDetectionRectAlpha(IIZ)V
    ...
    .line 14
    invoke-interface {v1, v0}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertMotionDetectionTip(I)V

    :cond_1
    if-eqz v2, :cond_2

    .line 15
    invoke-interface {v2}, Lcom/android/camera/protocol/ModeProtocol$ActionProcessing;->slowMotionDetectionRecordAnimator()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera2/Camera2Proxy;->setMotionDetectionEnable(Z)V
...
.method public slowMotionSuperClickEvent()Z
    ...
    invoke-interface {v0, v3, v5, v1}, Lcom/android/camera/protocol/ModeProtocol$SlowMotionViewProtocol;->setMotionDetectionCircleAlpha(IIZ)V

    .line 12
    invoke-interface {v2, v5}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertSlowMotionDisableRecordTip(I)V

    .line 13
    invoke-interface {v2, v5}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertMotionDetectionTip(I)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera2/Camera2Proxy;->setMotionDetectionEnable(Z)V
    ...
    .line 24
    invoke-interface {v2, v3}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertMotionDetectionTip(I)V
    ...
    invoke-interface {v0, v2, v3, v1}, Lcom/android/camera/protocol/ModeProtocol$SlowMotionViewProtocol;->setMotionDetectionRectAlpha(IIZ)V
    ...
    .line 29
    invoke-interface {v4}, Lcom/android/camera/protocol/ModeProtocol$ActionProcessing;->slowMotionDetectionRecordAnimator()V
...
.method public superSlowMotionDisableRecord(Landroid/content/Context;I)Z
    ...
    .line 8
    invoke-interface {p2, v1}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertSlowMotionDisableRecordTip(I)V
...
.method public useBackToStopRecording()Z
    ...
    check-cast v1, Lcom/android/camera/protocol/ModeProtocol$SlowMotionViewProtocol;
    ...
    invoke-static {v0, v1, v7}, Lcom/android/camera/ToastUtils;->showToast(Landroid/content/Context;IZ)V
    ...
    invoke-interface {v1, v3}, Lcom/android/camera/protocol/ModeProtocol$SlowMotionViewProtocol;->cancelRectAnimator(I)V
    ...
    iput-object v1, p0, Lcom/android/camera/module/video/SlowMotionModule;->mIsNeededPassThisRecording:Ljava/lang/Boolean;
    ...
    .line 15
    invoke-interface {v0, v1}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertMotionDetectionTip(I)V

    if-eqz v2, :cond_1

    .line 16
    invoke-interface {v2, v4}, Lcom/android/camera/protocol/ModeProtocol$ActionProcessing;->slowMotionBackEndRecord(Z)V
