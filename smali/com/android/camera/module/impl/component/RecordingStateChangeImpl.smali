...
.method private getCurrentModuleIndex()I
    ...
    .line 1
    iget-object v0, p0, Lcom/android/camera/module/impl/component/RecordingStateChangeImpl;->mActivity:Ljava/lang/ref/WeakReference;
...
.method public onFinish()V
    ...
    check-cast v5, Lcom/android/camera/protocol/ModeProtocol$HaloProtocol;
    ...
    check-cast v7, Lcom/android/camera/protocol/ModeProtocol$ThumbnailProtocol;
    ...
    .line 14
    invoke-interface {v6, v8, v9}, Lcom/android/camera/protocol/ModeProtocol$ModeSelector;->setModeLayoutVisibility(IZ)V

    .line 15
    :cond_1
    invoke-direct {p0, v0, v8}, Lcom/android/camera/module/impl/component/RecordingStateChangeImpl;->updateRightTips(Lcom/android/camera/protocol/ModeProtocol$TopAlert;I)V
    ...
    .line 17
    invoke-interface {v1, v4, v8}, Lcom/android/camera/protocol/ModeProtocol$BottomPopupTips;->updateDynamicImageForZoom(Lcom/android/camera/ui/zoom/ZoomIndexButtonsLayout;Z)V
    ...
    .line 23
    :cond_4
    invoke-interface {v0, v12}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->setRecordingTimeState(I)V
    ...
    .line 25
    invoke-virtual {v3, v8}, Lcom/android/camera/module/impl/component/ConfigChangeImpl;->recheckVideoFps(Z)V
    ...
    .line 29
    invoke-virtual {v3, v8}, Lcom/android/camera/module/impl/component/ConfigChangeImpl;->reConfigESPDisplay(Z)V
    ...
    .line 32
    invoke-interface {v5, v8}, Lcom/android/camera/protocol/ModeProtocol$HaloProtocol;->disableFrontFlashAndHalo(Z)V

    :cond_7
    if-eqz v7, :cond_22

    .line 33
    invoke-interface {v7, v9}, Lcom/android/camera/protocol/ModeProtocol$ThumbnailProtocol;->setThumbnailClickEnable(Z)V
    ...
    .line 46
    invoke-interface {v0, v9}, Lcom/android/camera/protocol/ModeProtocol$ConfigChanges;->reCheckParameterResetTip(Z)V
    ...
    .line 61
    invoke-interface {v0, v9, v1}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->enableMenuItem(Z[I)V
    ...
    .line 82
    invoke-virtual {v3, v9}, Lcom/android/camera/module/impl/component/ConfigChangeImpl;->reCheckParameterResetTip(Z)V
...
.method public onPrepare(Lcom/android/camera/module/Module;)V
    ...
    .line 4
    invoke-interface {v4, v1}, Lcom/android/camera/protocol/ModeProtocol$PresentationDisplay;->setESPRecordingTimeState(I)V
    ...
    invoke-virtual {v10}, Lcom/android/camera/data/data/extra/DataItemLive;->getTimerBurstController()Lcom/android/camera/timerburst/TimerBurstController;

    move-result-object v10

    .line 9
    invoke-virtual {v10}, Lcom/android/camera/timerburst/TimerBurstController;->isInTimerBurstShotting()Z
    ...
    .line 10
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$BackStack;->handleBackStackFromTimerBurstShutter()V
    ...
    .line 13
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$ActionProcessing;->processingPrepare()V
    ...
    .line 19
    invoke-interface {p1, v9}, Lcom/android/camera/protocol/ModeProtocol$CameraClickObservable;->subscribe(I)V
    ...
    .line 21
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$FilmDreamProcess;->processingPrepare()V
    ...
    .line 25
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$LiveVVProcess;->processingPrepare()V
    ...
    .line 29
    :cond_8
    invoke-interface {p1, v1}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->hideConfigMenu(Z)V
    ...
    .line 32
    invoke-interface {p1, v2}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->setRecordingTimeState(I)V
    ...
    .line 35
    invoke-interface {v0}, Lcom/android/camera/protocol/ModeProtocol$ManuallyAdjust;->onRecordingPrepare()V
    ...
    .line 42
    invoke-interface {p1, v2}, Lcom/android/camera/protocol/ModeProtocol$IndicatorProtocol;->clearIndicator(I)V
    ...
    .line 46
    invoke-interface {p1, v2, v2}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->setRecordingTimeState(IZ)V
    ...
    .line 64
    invoke-interface {p1, v1}, Lcom/android/camera/protocol/ModeProtocol$BottomPopupTips;->hideAllTipImage(Z)V

    .line 65
    invoke-interface {p1, v1}, Lcom/android/camera/protocol/ModeProtocol$BottomPopupTips;->hideAllTips(Z)V
