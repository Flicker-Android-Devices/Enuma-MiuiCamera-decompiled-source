...
.method private initManually()V
    ...
    .line 4
    invoke-interface {v0, v1, p0, v2, v3}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getManuallyAdapter(ILandroid/view/View$OnClickListener;Ljava/util/List;I)Lcom/android/camera/fragment/manually/adapter/ManuallyAdapter;
    ...
    check-cast v1, Lcom/android/camera/protocol/ModeProtocol$ProExtra;

    if-eqz v1, :cond_0

    .line 6
    invoke-interface {v1}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->updateData()V

    .line 7
    invoke-interface {v1}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->getCurrentTitle()I
...
.method private removeExtra()V
    ...
    .line 5
    invoke-interface {v0, v2, v2}, Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;->updateMaskCover(ZI)V
...
.method public getSelectComponentData()Lcom/android/camera/data/data/ComponentData;
    ...
    .line 1
    iget-object v0, p0, Lcom/android/camera/fragment/manually/FragmentManually;->mSelectComponentData:Lcom/android/camera/data/data/ComponentData;
...
.method public notifyDataChanged(II)V
    ...
    check-cast p2, Lcom/android/camera/protocol/ModeProtocol$ProExtra;
    ...
    invoke-interface {p2, p1, v0}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->notifyDataChanged(II)V
...
.method public onBackEvent(I)Z
    ...
    check-cast v0, Lcom/android/camera/protocol/ModeProtocol$ProExtra;
    ...
    .line 4
    invoke-interface {v0}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->getCurrentTitle()I
...
.method public onClick(Landroid/view/View;)V
    ...
    check-cast v5, Lcom/android/camera/protocol/ModeProtocol$ProExtra;
    ...
    .line 14
    invoke-interface {v5}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->isAdded()Z
    ...
    .line 15
    invoke-interface {v5}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->getCurrentTitle()I
    ...
    invoke-interface {v5, p1}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->updateRecordingState(Z)V

    .line 21
    invoke-interface {v5, v0}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->resetData(Lcom/android/camera/data/data/ComponentData;)V
    ...
    invoke-interface {p1, v4, v0}, Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;->updateMaskCover(ZI)V
    ...
    .line 31
    invoke-interface {v5, v4}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->setClickEnable(Z)V
...
.method public onRecordingPrepare()V
    ...
    invoke-interface {v1, v2}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->updateRecordingState(Z)V
...
.method public onRecordingStop()V
    ...
    invoke-interface {v0, v1}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->updateRecordingState(Z)V
...
.method public provideRotateItem(Ljava/util/List;I)V
    ...
    .line 8
    invoke-interface {v0, p1, p2}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->provideRotateItem(Ljava/util/List;I)V
...
.method public resetManually()V
    ...
    invoke-interface {v0, v1}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->resetData(Lcom/android/camera/data/data/ComponentData;)V
...
.method public setClickEnable(Z)V
    ...
    .line 3
    invoke-interface {v0}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->isAdded()Z
    ...
    .line 4
    invoke-interface {v0, p1}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->setClickEnable(Z)V
...
.method public updateEVState(I)V
    ...
    check-cast p1, Lcom/android/camera/protocol/ModeProtocol$ProExtra;

    if-eqz p1, :cond_3

    .line 16
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$ProExtra;->getCurrentTitle()I
