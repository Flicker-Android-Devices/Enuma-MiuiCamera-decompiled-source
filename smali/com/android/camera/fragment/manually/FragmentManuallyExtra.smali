...
# interfaces
.implements Lcom/android/camera/protocol/ModeProtocol$ProExtra;
...
.method private initAdapter(Lcom/android/camera/data/data/ComponentData;)V
    ...
    :sswitch_data_0
    .sparse-switch
        0x7f120730 -> :sswitch_3
        0x7f12074f -> :sswitch_3
        0x7f1207ea -> :sswitch_2
        0x7f1207fa -> :sswitch_1
        0x7f120828 -> :sswitch_3
        0x7f120848 -> :sswitch_0
    .end sparse-switch
.end method
...
.method private initHorizontalListView(Lcom/android/camera/data/data/ComponentData;Z)V
    ...
    .line 2
    iget-object p2, p0, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->mHorizontalViewLayout:Landroid/widget/LinearLayout;
    ...
    .line 11
    invoke-virtual {p1, p2, v3, v2, v3}, Landroid/view/View;->setPaddingRelative(IIII)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/camera/ui/HorizontalZoomView;->setSelection(I)V
    ...
    invoke-interface {p2, v2, v4}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getAutoResDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {p2, v4}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getAutoBackgroundResDrawable(I)I
    ...
    invoke-virtual {p1, v4, p2}, Lcom/android/camera/ui/ActivateImageView;->setActiveOrColorFilter(ZI)V
...
.method private initLensRecyclerView(Lcom/android/camera/data/data/ComponentData;)V
    ...
    invoke-interface/range {v2 .. v8}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getExtraRecyclerViewAdapter(Lcom/android/camera/fragment/BaseFragment;Lcom/android/camera/data/data/ComponentData;ILcom/android/camera/fragment/manually/ManuallyListener;II)Lcom/android/camera/fragment/manually/adapter/ExtraRecyclerViewAdapter;
...
.method private initSlideFocusView(Lcom/android/camera/data/data/ComponentData;)V
    ...
    invoke-interface {v2, v4, v5}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getAutoResDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v2, v5}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getAutoBackgroundResDrawable(I)I
...
.method private initWBRecyclerView(Lcom/android/camera/data/data/ComponentData;)V
    ...
    invoke-interface/range {v1 .. v7}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getExtraRecyclerViewAdapter(Lcom/android/camera/fragment/BaseFragment;Lcom/android/camera/data/data/ComponentData;ILcom/android/camera/fragment/manually/ManuallyListener;II)Lcom/android/camera/fragment/manually/adapter/ExtraRecyclerViewAdapter;
...
.method private setWidthAndGravity(Landroid/view/View;)V
    ...
    iput v0, p0, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->mRootViewWidth:F
...
.method private updateView()V
    ...
    .line 3
    iget-object v1, p0, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->mRootView:Landroid/view/View;
...
.method public animateOut()V
    ...
    .line 3
    new-instance v2, LOooO0O0/OooO0O0/OooO00o/Ooooo00/ooOO/OooO0O0;

    invoke-direct {v2, p0}, LOooO0O0/OooO0O0/OooO00o/Ooooo00/ooOO/OooO0O0;-><init>(Lcom/android/camera/fragment/manually/FragmentManuallyExtra;)V
...
.method public initView(Landroid/view/View;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->setWidthAndGravity(Landroid/view/View;)V

    .line 3
    invoke-direct {p0}, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->updateView()V
    ...
    invoke-interface {p1, v0}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getAutoImageView(Landroid/content/Context;)Lcom/android/camera/ui/ActivateImageView;
    ...
    .line 15
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$ManuallyAdjust;->getSelectComponentData()Lcom/android/camera/data/data/ComponentData;
...
.method public onDestroyView()V
    ...
    .line 2
    invoke-interface {v0, v1, v1}, Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;->updateMaskCover(ZI)V
...
.method public onManuallyDataChanged(Lcom/android/camera/data/data/ComponentData;Ljava/lang/String;Ljava/lang/String;ZI)V
    ...
    .line 14
    iget-boolean p1, p0, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->mIsRecording:Z
    ...
    invoke-virtual {p2}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o0O0ooo()Z
    ...
    invoke-virtual {p0, v2, p2}, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->showCustomWB(Lcom/android/camera/data/data/config/ComponentManuallyWB;Z)V
    ...
    .line 47
    invoke-interface {p1, p5}, Lcom/android/camera/protocol/ModeProtocol$ManuallyAdjust;->updateEVState(I)V
    ...
    .line 49
    invoke-interface {p2, v4}, Lcom/android/camera/protocol/ModeProtocol$ConfigChanges;->reCheckParameterResetTip(Z)V
    ...
    .line 51
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$ManuallyAdjust;->notifyDataSetChange()V
    ...
    :sswitch_data_0
    .sparse-switch
        0x7f120730 -> :sswitch_5
        0x7f12074f -> :sswitch_4
        0x7f1207ea -> :sswitch_3
        0x7f1207fa -> :sswitch_2
        0x7f120828 -> :sswitch_1
        0x7f120848 -> :sswitch_0
    .end sparse-switch
.end method
...
.method public provideOrientationChanged(ILjava/util/List;I)V
    ...
    .line 2
    iget-object p1, p0, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->mRootView:Landroid/view/View;
...
.method public showCustomWB(Lcom/android/camera/data/data/config/ComponentManuallyWB;Z)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/camera/ui/HorizontalZoomView;->setSelection(I)V

    .line 12
    iget-object p1, p0, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->mAutoButton:Lcom/android/camera/ui/ActivateImageView;

    invoke-virtual {p1, v2, v2}, Lcom/android/camera/ui/ActivateImageView;->setActiveOrColorFilter(ZI)V
    ...
    invoke-interface {p2, v0, v1}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getAutoResDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {p2, v1}, Lcom/android/camera2/compat/theme/MiThemeOperationManualInterface;->getAutoBackgroundResDrawable(I)I
...
.method public toUpdateAutoButton()V
    ...
    .line 2
    invoke-virtual {v0, v1, v1}, Lcom/android/camera/ui/ActivateImageView;->setActiveOrColorFilter(ZI)V
