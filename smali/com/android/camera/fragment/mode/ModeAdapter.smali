...
.method public createTouchHelper()Landroidx/recyclerview/widget/ItemTouchHelper;
    ...
    invoke-direct {v1, v2, v3, v4}, Lcom/android/camera/fragment/mode/ModeTouchHelperCallback;-><init>(Landroid/content/Context;Ljava/util/List;Lcom/android/camera/fragment/mode/IMoreMode;)V
...
.method public createViewHolder(Landroid/view/View;IZ)Lcom/android/camera/fragment/mode/ModeViewHolder;
    ...
    .line 1
    new-instance p2, Lcom/android/camera/fragment/mode/ModeViewHolderNormal;

    invoke-direct {p2, p1}, Lcom/android/camera/fragment/mode/ModeViewHolderNormal;-><init>(Landroid/view/View;)V
    ...
    .line 2
    invoke-virtual {p2}, Lcom/android/camera/fragment/mode/ModeViewHolderNormal;->getAnimView()Landroid/view/View;
    ...
    invoke-interface {p3, p1, v0}, Lmiuix/animation/ITouchStyle;->handleTouchOf(Landroid/view/View;[Lmiuix/animation/base/AnimConfig;)V
...
.method public onBindViewHolder(Lcom/android/camera/fragment/mode/ModeViewHolder;I)V
    ...
    invoke-virtual {v4, v10, v14}, Lcom/android/camera/customization/ThemeResource;->setVectorColor(Landroid/widget/ImageView;I)V
    ...
    invoke-virtual {v8, v4}, Lcom/android/camera/customization/ThemeResource;->getColor(I)I
    ...
    invoke-virtual {v3, v1, v2}, Lcom/android/camera/fragment/mode/MoreModeListAnimation;->startShowNewAnimation(Landroid/view/View;I)V
    ...
    invoke-virtual {v3, v1, v2}, Lcom/android/camera/fragment/mode/MoreModeListAnimation;->startShowOldAnimation(Landroid/view/View;I)V
...
.method public onBindViewHolder(Lcom/android/camera/fragment/mode/ModeViewHolder;ILjava/util/List;)V
    ...
    const-string/jumbo v2, "onBindViewHolderPayloads ,position = "
    ...
    .line 89
    iget p2, p3, Lcom/android/camera/fragment/mode/ModeAdapter$PlayLoad;->downloadState:I
    ...
    .line 93
    invoke-virtual {p1, p2, p3}, Lcom/android/camera/fragment/mode/ModeViewHolder;->setProgress(IZ)V
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Lcom/android/camera/fragment/mode/ModeViewHolder;
    ...
    invoke-direct {p2, p0}, LOooO0O0/OooO0O0/OooO00o/Ooooo00/o00O0O/OooO0o0;-><init>(Lcom/android/camera/fragment/mode/ModeAdapter;)V
    ...
    .line 21
    :goto_1
    iget p1, p0, Lcom/android/camera/fragment/mode/ModeAdapter;->mDegree:F

    invoke-virtual {v0, p1}, Lcom/android/camera/fragment/mode/ModeViewHolder;->setRotation(F)V
...
.method public onViewAttachedToWindow(Lcom/android/camera/fragment/mode/ModeViewHolder;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/camera/fragment/mode/ModeViewHolder;->setRotation(F)V
