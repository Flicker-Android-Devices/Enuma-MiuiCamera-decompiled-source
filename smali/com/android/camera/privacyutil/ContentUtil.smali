...
.method public checkContentCompliance(Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Lcom/miui/riskcontrol/SensitiveWordUtils;->isSupported(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    const-string p1, "ContentUtil"

    const-string v0, "SDK is unsupported"
    ...
    invoke-static {v0, p1}, Lcom/miui/riskcontrol/SensitiveWordUtils;->detect(Landroid/content/Context;Ljava/lang/String;)Z
