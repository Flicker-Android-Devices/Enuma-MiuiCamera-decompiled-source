...
.method public gotoGallery()V
    ...
    invoke-virtual {v0, v4}, Lcom/android/camera/ThumbnailUpdater;->getLastThumbnailUncached(Z)V
    ...
    invoke-virtual {v5}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o000O0O()Z
    ...
    invoke-virtual {v6}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o000O0O()Z
    ...
    :cond_a
    :goto_3
    invoke-static {p0, v1}, Lcom/android/camera/Util;->isAppLocked(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_b

    const-string/jumbo v1, "skip_interception"
    ...
    invoke-virtual {v5, v1, v6}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[J)Landroid/content/Intent;
    ...
    invoke-virtual {v5, v1, v6}, Landroid/content/Intent;->putParcelableArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;
    ...
    const-string/jumbo v1, "review activity not found!"
...
.method public isKnockLaunchSource()Z
    ...
    .line 2
    invoke-virtual {v0}, Lcom/android/camera/CameraIntentManager;->isKnockLaunchSource()Z
