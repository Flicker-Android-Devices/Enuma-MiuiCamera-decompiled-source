...
.method private applySort(Ljava/util/List;Ljava/util/Map;)V
    ...
    invoke-virtual {p2, v2, v3}, Lcom/android/camera/data/data/DataItemBase;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p2}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->OoooO0()[I
    ...
    .line 17
    :cond_5
    sget p2, Lcom/android/camera/data/data/global/DataItemGlobal;->DEFAULT_MODE_DISMISS_REMOVE_QUANTITY:I

    new-array v2, p2, [I

    .line 18
    sget v4, Lcom/android/camera/data/data/global/DataItemGlobal;->DEFAULT_MORE_MODE_INDEX:I
    ...
    .line 19
    :goto_2
    sget v8, Lcom/android/camera/data/data/global/DataItemGlobal;->DEFAULT_MORE_MODE_INDEX:I
...
.method private declared-synchronized initItems()Ljava/util/List;
    ...
    invoke-virtual {v1}, LOooO0O0/OooO0Oo/OooO00o/OooO00o;->o0ooOoO()Ljava/lang/String;
    ...
    invoke-interface {v7, v8, v9}, Lcom/android/camera2/compat/theme/MiThemeOperationTabIf;->getModeDrawableRes(Landroid/content/Context;I)I
